...
@app.get("/jugadores", response_model=List[Jugar], tags = ["personas"])
def get_jugadores():
    return jugarList

@app.get("/jugadores/{jugador_id}", response_model=Jugar, tags = ["personas"])
...
@app.delete("/jugadores/{jugador_id}", tags = ["personas"])
